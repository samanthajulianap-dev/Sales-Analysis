...
Key Highlights
Built a clean and interactive multi-page dashboard
Implemented YTD calculations using DAX
Designed visuals to support both high-level and detailed analysis
Focused on clarity and usability for business users
Tools Used
Power BI
Excel
DAX
